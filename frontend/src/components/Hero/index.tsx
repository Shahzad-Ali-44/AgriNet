          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="my-5 md:mb-5 md:mt-0 text-2xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-4xl md:leading-tight text-left md:text-center">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  <Link
                    href="#features"
                    className="rounded-sm bg-lime-600 px-8 py-4 text-base font-semibold text-black duration-300 ease-in-out hover:bg-lime-700 hover:text-white"
                  >
                    🔥 Try Now
                  </Link>
