    ...
    <div className="flex flex-col items-center py-10 px-8 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-lg shadow-lg dark:shadow-md w-full max-w-2xl mx-auto border border-gray-200 dark:border-gray-700">
      ...
      {result && (
        <div className="mt-8 p-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-inner w-full text-center border border-gray-200 dark:border-gray-600">
          ...
          <p className="text-md text-gray-600 dark:text-gray-300 mt-2 text-left"><b>Symptoms: </b>
             {result.symptoms}
          </p>
          <p className="text-md text-gray-600 dark:text-gray-300 mt-2 text-left"><b>Treatment: </b>
            {result.treatment}
          </p>
        </div>
      )}
